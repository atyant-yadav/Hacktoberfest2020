...
pho:-   %Preguntas del test:
        ...
        new(Pre11,menu('11. Diseñar y planificar la producción masiva de artículos')),
        send_list(Pre11,append,[si , no]),
        new(Pre12,menu('12. Te gusta la programación o cosas que tenga que ver con computadoras')),
...
areaI(_,P2,P3,_,_,_,_,_,_,_,_,_,_,P14,_,_,_,P18,_,_):-
                                                      ...
                                                      pf3('C:/Programa/imagen5.jpg','CIENCIAS ECOLÓGICAS, BIOLÓGICAS Y DE LASALUD:
